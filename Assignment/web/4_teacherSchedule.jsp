            ...
            <div class="card " style="margin:20px; width:900px;">
                <div class="card-body ">
                    ...
                    <form action="classManage" method="post">
                            ...
                            <%                                int start = 830;
                                ...
                                for (int i = 0; i < 9; i++) {
                                    ...
                                    for (int j = 0; j <= 44; j += 9) {
                                        ...
                                        out.println("<td><select name=\"item" + (j + test) +  "\">");
                                        for (int k = 0; k < subjects.size(); k++) {
                                            Subject tempSubject = subjects.get(k);
                                            String se = "";
                                            if (tempSubject.getId() == s.getSubjectID()) {
                                                se = "selected";
                                            }
                                            out.println("<option value=\"" + tempSubject.getId() + "\"" + se + ">" + tempSubject.getName() + "</option>");
                                        }
                        ...
                        <input type="submit" value="Save" class="btn btn-primary my-2 my-sm-0"/>
                        <input type="reset" value="Undo All" class="btn btn-warning my-2 my-sm-0"/>
                    </form>
