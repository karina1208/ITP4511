        ...
        <div class="align-items-center d-flex justify-content-center">
            <div class="card " style="margin:20px; width:600px;">
                <div class="card-body ">
                    ...
                    <form method="post" action="getStudents?action=dayAttendance">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <input type="hidden" name="action" value="dayAttendance"/>
                            <%

                                
                                for (int i = 0; i < students.size(); i++) {
                                    Student s = students.get(i);
                                    out.println("<tr><td><input type=\"checkbox\" name=\"status\" value=\"" + s.getStudentId() + "\"/></td>");
