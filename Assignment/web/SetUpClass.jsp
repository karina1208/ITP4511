<%-- 
    Document   : SetUpClass
    Created on : 2019?12?26?, ??11:27:41
    Author     : yusin
--%>
    ...
    <body>
        ...
        <div class="container" >       
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <form method="post" action="getClass?action=add"  >
                    <p><h2 class="mb-3">Create Class</h2></p>                        
                    <p><label>Class ID :&nbsp;</label><input type="text" class="form-control" name="classID"/><br /></p>
                    <p><label>Class Name :&nbsp; </label><input type="text" class="form-control" name="className"/><br /></p>
                    <p><label>schoolday :&nbsp;</label><input type="text" class="form-control mr-sm-2"  name="schoolday"/><br /></p>                    
